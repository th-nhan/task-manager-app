...
export const TimetableStatsCards = ({ timetableItems = [] }) => {
    ...
    return (
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-xs border border-pink-100 flex flex-col justify-between hover:shadow-md transition-all">
                <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Total Schedule</span>
                ...
                <div className="mt-2">
                    <div className="flex items-baseline gap-2">
                        <span className="text-xl sm:text-2xl font-black text-gray-800">{totalSessions}</span>
            ...
            <div className="bg-white rounded-2xl p-4 shadow-xs border border-pink-100 flex flex-col justify-between hover:shadow-md transition-all">
                <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Grade Distribution</span>
                    <div className="w-8 h-8 rounded-xl bg-indigo-100 flex items-center justify-center text-indigo-500 shrink-0">
                ...
                <p className="text-[11px] text-gray-400 mt-1 truncate">Focus on Grade 12 ({grade12Count} slots)</p>
            </div>

            {/* Card 3: Location distribution */}
            <div className="bg-white rounded-2xl p-4 shadow-xs border border-pink-100 flex flex-col justify-between hover:shadow-md transition-all">
                <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Teaching Locations</span>
                ...
                <p className="text-[11px] text-gray-400 mt-1 truncate">Long Thượng ({ltCount}) • Mỹ Lộc ({mlCount})</p>
            </div>

            {/* Card 4: Weekend focus */}
            <div className="bg-gradient-to-br from-pink-500 to-rose-500 text-white rounded-2xl p-4 shadow-xs flex flex-col justify-between hover:shadow-md transition-all">
                <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-pink-100 uppercase tracking-wider">Weekend (Sat - Sun)</span>
                ...
                <div className="mt-2">
                    <div className="flex items-baseline gap-2">
                        <span className="text-xl sm:text-2xl font-black">{weekendCount}</span>
